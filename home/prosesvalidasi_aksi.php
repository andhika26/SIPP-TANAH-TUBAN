...
if (isset($_POST['simpan'])) {
	...
	else
	{
        ...
        $query = mysqli_query($koneksi,"UPDATE tbl_validasi SET tgl_terima='$tgl_terima', setor_ke='$setor_ke', tgl_setor='$tgl_setor', updated='$update_at', status='$status'  WHERE DI302='$no302' ");  
