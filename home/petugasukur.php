...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>SPK Petugas Ukur</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">SPK Petugas Ukur</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><b>SPK Petugas Ukur</b></h3>
	...
	$now = date("d-m-Y");
	  ...
	  ?>
              <tr>
                <td><a href="?page=submitukur&&id=<?php echo $r[1]; ?>"><?php echo $r[0]; ?></a></td>
				...
				<td><?php echo $r[9]; ?></td>
				<td><?php echo $r[10]; ?></td>
                <td><a href="?page=submitukur&&id=<?php echo $r[1]; ?>"><button class="btn btn-block btn-success btn-sm">Edit</button></a></td>
              </tr>
              <?php
  endwhile;
  }
